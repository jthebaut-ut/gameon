...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.55;color:#1a1a1a;max-width:640px">
  <h1 style="font-size:20px;font-weight:650;margin:0 0 18px;color:#0f172a">GameOn support request</h1>
  ...
  <p style="margin-top:22px;font-size:12px;color:#64748b">Generated by GameOn notify-support-request.</p>
</body>
</html>`
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from: resendFrom,
      to: [adminTo],
      subject: `GameOn support — ${cat} — ${subject.slice(0, 80)}${subject.length > 80 ? "…" : ""}`,
      html,
    }),
  })
