...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.55;color:#1a1a1a;max-width:720px">
  ...
  <p style="margin-top:22px;font-size:12px;color:#64748b">Generated by GameOn notify-venue-claim · submitter user id ${escapeHtml(user.id)}</p>
</body>
</html>`

  const subjectPrefix =
    kind === "new_location"
      ? "GameOn — New location request"
      : kind === "discover_claim"
        ? "GameOn — Discover venue claim"
        : "GameOn — Venue claim"
