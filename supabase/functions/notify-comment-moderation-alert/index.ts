...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.55;color:#1a1a1a;max-width:720px">
  <h1 style="font-size:20px;font-weight:650;margin:0 0 18px;color:#0f172a">[FanGeo Moderation] Comment Auto-Hidden</h1>
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from: resendFrom,
      to: [adminTo],
      subject: "[FanGeo Moderation] Comment Auto-Hidden",
      html,
    }),
  })
