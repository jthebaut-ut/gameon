...
CITY_BOXES = {
    ...
    "North France": [
    (50.55, 2.90, 50.75, 3.20),      # Lille / Roubaix / Tourcoing
    (50.35, 2.70, 50.50, 2.90),      # Lens / Liévin
    (50.20, 2.65, 50.35, 2.90),      # Arras
    (50.30, 3.00, 50.45, 3.20),      # Douai
    (50.25, 3.35, 50.45, 3.65),      # Valenciennes
    (50.95, 2.20, 51.10, 2.45),      # Dunkerque
    (50.85, 1.75, 51.00, 2.00),      # Calais
    (49.80, 2.20, 50.00, 2.45),      # Amiens
    (50.45, 2.45, 50.65, 2.75),      # Béthune
    (50.15, 3.15, 50.30, 3.35),      # Cambrai
    (49.80, 3.15, 49.95, 3.35),      # Saint-Quentin
],
