...
struct FollowingScreen: View {
    ...
    var goingPlans: [(bar: BarVenue, gameTitle: String, date: String, time: String, count: Int)] {
    ...
    private func goingPlanCard(_ plan: (bar: BarVenue, gameTitle: String, date: String, time: String, count: Int)) -> some View {
