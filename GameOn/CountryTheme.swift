...
struct CountryTheme {
    ...
    private static let themes: [CountryTheme] = [
        ...
        CountryTheme(canonicalName: "Curaçao", regionCode: "CW", colors: [Color(red: 0.00, green: 0.28, blue: 0.66), Color(red: 1.0, green: 0.82, blue: 0.08), .white], accent: Color(red: 1.0, green: 0.76, blue: 0.12), textColors: [Color(red: 0.42, green: 0.68, blue: 1.0), Color(red: 1.0, green: 0.86, blue: 0.16), .white], aliases: ["curacao", "curacao national team", "curaçao national team", "cuw"]),
