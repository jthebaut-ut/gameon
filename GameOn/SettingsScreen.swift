            ...
            List {
                if viewModel.isLoggedIn {
                    ...
                    Section {
                        Button {
                            ...
                            settingsRow(title: "Sign in or create account", subtitle: "Sync your profile and activity.", systemImage: "person.crop.circle.badge.plus")
                        }
                        .buttonStyle(.plain)
                    }
                }
                ...
                Section("ACCOUNT") {
                    if viewModel.isLoggedIn {
                        ...
                        Button {
                            // Placeholder until a full blocked-users manager view is added.
                        } label: {
                            settingsRow(title: "Blocked Users", subtitle: "Coming soon.", systemImage: "hand.raised")
                        }
                        .buttonStyle(.plain)
                        .disabled(true)
                        .opacity(0.6)
